// Dafny program daf.dfy compiled into C#
...
// Command Line Options: c:\Work_in_Programs\2do_año\daf.dfy /verifyAllModules /spillTargetCode:1 /compile:3 /out:bin\daf
// daf.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger ray(BigInteger b, BigInteger a)
    {
    ...
    public static BigInteger troyan(BigInteger x)
    {
      BigInteger z = BigInteger.Zero;
      z = (x) + (new BigInteger(2));
      return z;
      return z;
    }
